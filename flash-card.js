...
nextButton.addEventListener('click', (e) => {
  ...
  const word = document.querySelector('.flash-card:not(.flash-card--answer) .word');
  const translation = document.querySelector('.flash-card--answer .translation');
  const translations = document.querySelector('.flash-card--answer .other-translations');
  const newWord = getRandomWord(words);
  
  word.innerText = newWord.spanish;
  translation.innerText = newWord.english;
  translations.innerText = newWord.translations.join(', ');
...
flipButton.addEventListener('click', (e) => {
  ...
  const back = document.querySelector('.flash-card--answer');
